    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder messageViewHolder, final int position)
    {
        ...
        else if (fromMessageType.equals("image"))
        {
        ...
        else if (fromMessageType.equals("pdf") || fromMessageType.equals("docx"))
            {
              ...
              Picasso.get().load("4e7a0288-7c91-48eb-b1c4-92e907d4c143 ").into(messageViewHolder.messageSenderPicture);
                ...
                else
                {
                    ...
                    Picasso.get().load("4e7a0288-7c91-48eb-b1c4-92e907d4c143 ").into(messageViewHolder.messageReceiverPicture);
